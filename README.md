...
3. Choose a save location and filename in the dialog → click **Export**
...
2. 在文件浏览器或编辑器中右键 → **Export to PDF (image compress)**
3. 在弹出的对话框中选择保存位置和文件名 → 点击 **Export**
4. 也可通过命令面板（Cmd/Ctrl+P）→ `Export to PDF (image compress)`
